...
function Navbar() {
  ...
  >
    <line
      ...
      y2="24"
    />
    <circle fill="currentColor" cx="3" cy="24" r="2" />
    <polygon
      fill="none"
      stroke="currentColor"
      strokeWidth="2"
      ...
      <nav className={`navbar ${isModalOpen ? "transparent" : ""}`}>
        <div className="navbar-container">
          ...
          <div className="navbar-buttons">
            ...
            >
              <svg width="24px" height="24px" viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            ...
            >
              <svg width="24px" height="24px" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7.5 7.5C9.433 7.5 11 5.933 11 4C11 2.067 9.433 0.5 7.5 0.5C5.567 0.5 4 2.067 4 4C4 5.933 5.567 7.5 7.5 7.5ZM7.5 8.5C5.015 8.5 0.5 9.675 0.5 12.165V14.5H14.5V12.165C14.5 9.675 9.985 8.5 7.5 8.5Z" stroke="currentColor" />
              </svg>
            </button>
