...
//                         <input className="input-fname" type="text" placeholder="First Name" required />
//                         <input className="input-lname" type="text" placeholder="Last Name" required />
//                     </div>
...
function Register() {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            console.log('register called', { fullName, email, password });
                ...
                <div className="registerBox">
                    ...
                    <div className="nameBox">
                        <input
                            ...
                            value={firstName}
                            onChange={(e) => { setFirstName(e.target.value); console.log('firstName', e.target.value); }}
                            required
                        />
                        <input
                            ...
                            value={lastName}
                            onChange={(e) => { setLastName(e.target.value); console.log('lastName', e.target.value); }}
                            required
                        />
                    </div>
